<div class="mt-2 col-span-6 md:grid grid-cols-6 gap-4 md:items-center">
    ...
    <div class="block mt-3 md:col-start-3 col-end-6">
        ...
        <input class="block w-full text-sm text-gray-500 border border-gray-300 rounded-lg cursor-pointer bg-primary focus:outline-none" aria-describedby="file_input_help" id="{{$id}}" type="file" name="{{$name}}" accept="image/*" multiple required>
