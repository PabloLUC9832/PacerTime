    ...
    <div class="block mt-3 md:col-start-3 col-end-6">
        ...
        <div date-rangepicker class="flex">
            <div class="relative">
                ...
                <input name="fechaInicio{{$name}}" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5" placeholder="Selecciona la fecha de inicio">
            ...
            <div class="relative">
                ...
                <input name="fechaFin{{$name}}" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5" placeholder="Selecciona la fecha de finalización">
