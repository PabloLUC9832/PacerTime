        ...
        <div class="block border border-gray-200 rounded-lg hover:bg-secondary">
            ...
            <div class="flex justify-end px-4 pt-2">
                ...
                <div id="dropdown" class="bg-gray-700 z-10 hidden text-base list-none divide-y divide-gray-100 rounded-lg shadow w-44">
                    <ul class="py-2" aria-labelledby="dropdownButton">
                        ...
                        <li>
                            <a data-modal-toggle="delete-modal{{$evento->id}}" class="block px-4 py-2 text-sm text-red-600 hover:bg-gray-600">Eliminar</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="flex flex-col justify-between p-2">
                ...
                <h5 data-drawer-target="drawer-info{{$evento->id}}" data-drawer-show="drawer-info{{$evento->id}}" data-drawer-placement="right" aria-controls="drawer-info{{$evento->id}}" data-drawer-body-scrolling="true"
                    class="inline-flex items-center text-lg font-bold tracking-tight text-white text-justify cursor-pointer" >{{$evento->nombre}}
