    ...
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="shadow sm:overflow-hidden sm:rounded-md">
            ...
            <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
                ...
                <x-input  name="nombre" message="Nombre del evento"></x-input>
                ...
                <x-input  name="lugarEvento" message="Lugar del evento"></x-input>

                <x-date-picker name="Evento" message="Fecha del evento"></x-date-picker>

                <x-time-picker name="Evento" message="Hora de inicio del evento"></x-time-picker>
                ...
                <x-input  name="lugarEntregaKits" message="Lugar de la entrega de kits"></x-input>

                <x-date-picker name="EntregaKits" message="Fecha de la entrega de kits"></x-date-picker>

                <x-time-picker name="InicioEntregaKits" message="Hora de inicio de la entrega de kits"></x-time-picker>

                <x-time-picker name="FinEntregaKits" message="Hora de finalización de la entrega de kits"></x-time-picker>
