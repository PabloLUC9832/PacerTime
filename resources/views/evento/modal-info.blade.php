...
<div id="drawer-info{{$evento->id}}" class="fixed top-0 right-0 z-40 h-screen p-4 overflow-y-auto transition-transform translate-x-full bg-gray-800 w-80" tabindex="-1" aria-labelledby="drawer-right-label">
    ...
    <!--EDITAR Y ELIMINAR-->
        ...
        <div class="grid grid-cols-2 gap-4 mt-1.5 bg-secondary sticky bottom-0">
            ...
            <a href="{{route('eventos.edit',$evento->id)}}" class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:ring-2 focus:ring-blue-800 focus:outline-none">
