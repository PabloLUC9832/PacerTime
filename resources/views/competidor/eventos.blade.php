...
@section('content')
    ...
    <form action="{{route('competidor.eventos')}}" method="GET" value="{{$search}}" class="flex items-center mb-4">
    ...
    @if(count($eventos)<=0)
        <p class="text-xl font-bold text-white">
            No se ha encontrado eventos :(. <a href="{{route('competidor.eventos')}}" class="text-blue-500 hover:underline">Ver eventos disponibles</a>
        </p>
    @else
